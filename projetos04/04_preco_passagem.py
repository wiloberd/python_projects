...
passagem_nomal = (distancia_informada * 0.50)
passagem_promocional = (distancia_informada * 0.45)

print('{} o preço total da sua passagem vai ficar R${:.2f}.'.format(aviso_passagem, passagem_nomal) if distancia_informada <= 200  else '{} o preço total da sua passagem vai ficar R${:.2f}.'.format(aviso_passagem, passagem_promocional))
